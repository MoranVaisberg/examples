...
public class UserService {
	...
	@PostMapping("/uploadprojecttopicsfile")
	public ResponseEntity<String> uploadProjectTopicsFile(@RequestParam("customerName") String customerName, @RequestParam("projectName") String projectName, @RequestParam("file") MultipartFile file) throws IOException {

		String status = "OK";
		return ("OK".equals(status))? new ResponseEntity<>(status, HttpStatus.OK) : new ResponseEntity<>(status, HttpStatus.UNPROCESSABLE_ENTITY);
